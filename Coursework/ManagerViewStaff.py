...
class ViewStaffGUI(main):
    ...
    def __init__(self, master, height, width, bgcolour, framecolour, title):
        ...
        self.ConfirmStaffBtn = Button(self.master, text='View Staff', command=self.DataValidation, font=('Calibri', 12), width=15).grid(column=1, row=3, pady=5)
    ...
    def DisplayStaffInfo(self, StaffID, FirstName, Surname, MobileNum, TelephoneNum, Email, Address, PostCode, DOB, Gender, JobTitle, NIN, HourlyRate, ContractedHours, Username):
        ...
        self.ViewAnotherBtn = Button(self.master, text='Delete', command=self.ViewAnother, font=('Calibri', 12), width=15).grid(column=2, row=10, pady=5)
    ...
    def ViewAnother(self):
        ...
        DeleteStaffGUI(self.master, 500, 650, '#85C1E9', '#EBF5FB', 'View Staff')
...
if __name__ == '__main__':
    root = Tk()
    gui = ViewStaffGUI(root, 500, 650, '#85C1E9', '#EBF5FB', 'View Staff')
    root.mainloop()